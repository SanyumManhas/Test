export default function HeroSection(){
    return(
        <>
            <div class="container-fluid mt-3 mb-5 bg-transparent ">
                <div className="container ms-4 hero-back">
                    <div class="row align-items-center hero-tint">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 hero-block ht-class">
            ...
            <div class="container-fluid py-5 mb-5">
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 wow fadeIn position-relative" data-wow-delay="0.5s">
            ...
            {/* Featured items section */}
             <div class="container-fluid py-5 mg-top">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-6 col-sm-6 col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="product-item p-0 rounded">
                        ...
                        <div className="p-0">
                            ...
                            <p class="mb-4 text-dark ps-2 pb-2" style={{fontSize:'0.7em'}}>
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="product-item p-0 rounded">
                        <img className="img-fluid mb-2 p-2  br-class" src="img/infoHero.jpeg" alt=""/>
                        <div className="p-0">
                            <h6 class="mb-2 ps-2" style={{fontSize:"0.9em"}}>Frosted Brew Candle</h6>
                            <p class="mb-4 text-dark ps-2 pb-2" style={{fontSize:'0.7em'}}>
                                frosted brew candle with experience of coffee and wax
